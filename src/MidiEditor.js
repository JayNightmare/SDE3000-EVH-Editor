            ...
            <div className="max-w-6xl mx-auto">
                ...
                {connected && (
                    ...
                    >
                        ...
                        <div className="glass-card slide-in" style={{ padding: '2rem' }}>
                            ...
                            <div style={{ 
                                ...
                                {[1, 2, 3, 4, 5, 6].map((slot) => (
                                    <button
                                        key={slot}
                                        className={currentSlot === slot ? "btn-primary" : "btn-secondary"}
                        ...
                        {/* Parameters */}
                        <div className="glass-card slide-in" style={{ padding: '2rem', animationDelay: '0.2s' }}>
                            <h2 style={{ 
                                fontSize: '1.5rem', 
                                fontWeight: '700', 
                                marginBottom: '1.5rem',
                            ...
                            <div style={{ 
                                ...
                                {paramDefs.map((pd) => (
                                    <div key={pd.id} className="glass-card" style={{ padding: '1.5rem' }}>
                                        <label style={{ 
                                            display: 'block', 
                                            marginBottom: '1rem', 
                                            fontWeight: '600',
                        ...
                        {/* Actions */}
                        <div className="glass-card slide-in" style={{ padding: '2rem', animationDelay: '0.4s' }}>
                            <h2 style={{ 
                                fontSize: '1.5rem', 
                                fontWeight: '700', 
                                marginBottom: '1.5rem',
